...
import 'package:repartir_frontend/pages/mentors/messagedetails.dart';
...
class _MentorChatListPageState extends State<MentorChatListPage> {
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => MentorChatDetailPage(contact: contact),
                              ),
                            );
                          },
                        );
