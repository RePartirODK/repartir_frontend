...
class _DetailOffrePageState extends State<DetailOffrePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final offreData = widget.offre.isNotEmpty ? widget.offre : {
      ...
      'description': 'Rejoignez notre équipe pour travailler sur des projets innovants en Java et Spring Boot. Vous participerez au développement d\'applications web modernes et collaborerez avec une équipe dynamique.',
      'competence': 'Java, Spring Boot',
      'date_debut': '2025-01-15 09:00:00.000000',
      'date_fin': '2025-12-31 18:00:00.000000',
